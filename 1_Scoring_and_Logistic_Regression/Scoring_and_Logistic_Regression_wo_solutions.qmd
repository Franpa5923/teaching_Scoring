...
We get a value of `r round(bayes_test_risk,3)` for the Bayes risk, in line with [@hastie2009 Figure 13.4], see below:
...
don_desbois <- read.spss("../data/presentation_data/Agriculture Farm Lending/desbois.sav",
...
# In our case we have 6 terminal nodes
# We vary s in [0, 1] to compute the ROC parametric curve 
